...
const ProfData = () => {
    ...
    return (
        <>
        <Navbar />
        <div style={{display:'flex',justifyContent:"center",flexWrap:"",paddingTop:"130px"}}>
                ...
                <div className='username'>
                    ...
                    <div style={{display:"flex",alignItems:"center",justifyContent:"space-evenly",width:"70%",fontFamily:"sans-serif",flexWrap:"revert"}}>
                        <div className='col1' style={{width:"40%",display:"flex",flexDirection:"column"}}>
                            ...
                            <hr></hr>
                            <h3>Followers</h3>
                            <h4 onClick={handleFollowers} style={{backgroundColor:"white",padding:"15px",width:"100%",border:"solid 1px"}}>{userData.followers.length}</h4>
                        </div>
